...
export const deps: any = {
  ...
  'fedora-x64': {
    ...
    lib2package: {
      ...
      'libdrm.so.2': 'libdrm',
      'libenchant-2.so.2': 'enchant2',
      'libepoxy.so.0': 'libepoxy',
      'libevent-2.1.so.7': 'libevent',
      'libflite_cmu_grapheme_lang.so.1': 'flite',
      'libflite_cmu_grapheme_lex.so.1': 'flite',
      'libflite_cmu_indic_lang.so.1': 'flite',
      'libflite_cmu_indic_lex.so.1': 'flite',
      'libflite_cmu_time_awb.so.1': 'flite',
      'libflite_cmu_us_awb.so.1': 'flite',
      'libflite_cmu_us_kal.so.1': 'flite',
      'libflite_cmu_us_kal16.so.1': 'flite',
      'libflite_cmu_us_rms.so.1': 'flite',
      'libflite_cmu_us_slt.so.1': 'flite',
      'libflite_cmulex.so.1': 'flite',
      'libflite_usenglish.so.1': 'flite',
      'libflite.so.1': 'flite',
      ...
      'libgstallocators-1.0.so.0': 'gstreamer1-plugins-base',
      'libgstapp-1.0.so.0': 'gstreamer1-plugins-base',
      'libgstaudio-1.0.so.0': 'gstreamer1-plugins-base',
      'libgstbase-1.0.so.0': 'gstreamer1',
      'libgstcodecparsers-1.0.so.0': 'gstreamer1-plugins-bad-free',
      'libgstfft-1.0.so.0': 'gstreamer1-plugins-base',
      'libgstgl-1.0.so.0': 'gstreamer1-plugins-base',
      'libgstpbutils-1.0.so.0': 'gstreamer1-plugins-base',
      'libgstreamer-1.0.so.0': 'gstreamer1',
      'libgsttag-1.0.so.0': 'gstreamer1-plugins-base',
      'libgstvideo-1.0.so.0': 'gstreamer1-plugins-base',
      'libgtk-3.so.0': 'gtk3',
      'libgtk-4.so.1': 'gtk4',
      'libharfbuzz-icu.so.0': 'harfbuzz-icu',
      'libharfbuzz.so.0': 'harfbuzz',
      'libhyphen.so.0': 'hyphen',
      'libicudata.so.74': 'libicu',
      'libicui18n.so.74': 'libicu',
      'libicuuc.so.74': 'libicu',
      'libjpeg.so.8': 'libjpeg-turbo',
      'liblcms2.so.2': 'lcms2',
      'libmanette-0.2.so.0': 'libmanette',
      'libnspr4.so': 'nspr',
      'libnss3.so': 'nss',
      'libnssutil3.so': 'nss',
      'libopus.so.0': 'opus',
      ...
      'libvpx.so.9': 'libvpx',
      'libwayland-client.so.0': 'wayland-client',
      'libwayland-egl.so.1': 'wayland-client',
      'libwayland-server.so.0': 'wayland-server',
      'libwebp.so.7': 'libwebp',
      'libwebpdemux.so.2': 'libwebp',
      'libwoff2dec.so.1.0.2': 'woff2',
      'libX11-xcb.so.1': 'libX11-xcb',
      'libX11.so.6': 'libX11',
      'libx264.so': 'x264-libs',
